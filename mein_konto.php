...
<div style="color:white;font-size:1.1em;">
		...
		<form method=POST action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
			...
			<label for="id" style="color:white;">Bitte geben Sie Ihre ID ein: 
			<b class="error"  style="color:red;">* <?php echo "<br>".$idErr;?></b></label>		
			<input name="id" type="number" class="feedback-input" placeholder="ID"  min="1" max="1000" value="<?php echo $id;?>">
			
			
			<label for="id_score">Bitte wählen Sie: <b class="error" style="color:red;">*<?php echo $scoreErr;?></b></label>		
