...
*/			}
	...
	//var_dump($_SERVER);
			...
			switch($geschlecht) {
			case "maennlich": $anrede = "Herr"; break;
			case "weiblich": $anrede = "Frau"; break;
...
<div class="body">
		...
		<label for="email">E-mail</label>
			<input type="text" name="email" id="email"  class="feedback-input" placelolder="E-Mail" value="<?php echo $email;?>">
