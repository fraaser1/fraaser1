...
require_once "../php/config.php";
 ...
 $geschlecht = $vorname = $nachname = $begruessung = $benutzername = $email = $localFileName =  $id =$emailErr = $benutzernameErr = $vornameErr = $nachnameErr = $geschlechtErr = $anrede = "";
$zaehler = 0;
...
<div class="body">
	...
	<form method = "POST"  action ="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>#ausgabe"  enctype="multipart/form-data">
...
<div id="ausgabe" style="text-align:center;color:white;font-size:1.1em;">
	<?php
		if($zaehler >= 5){
